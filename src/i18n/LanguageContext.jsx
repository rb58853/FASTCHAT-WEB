...
const translations = {
  en: {
    ...
    chat: {
      ...
      title: 'Clear answers with a visible flow.',
      subtitle:
        'While Fastchat analyzes your request and selects services, you will see active animation and live progress steps.',
      emptyKicker: 'Ask a question',
      emptyTitle: 'Start with a query or use a suggestion to test the new flow.',
      emptyText:
        'The interface now displays activity while the system prepares context, consults services, and builds the response.',
      ...
      connectingText: 'We are preparing the session so the flow is visible from the first moment.',
    ...
    messageLabels: {
      ...
      processingTitle: 'Selecting services and organizing the flow',
      processingText:
        'Fastchat displays each stage while deciding which tools to use and how to build the final answer.',
    },
    workflow: {
  ...
  es: {
    ...
    chat: {
      ...
      title: 'Respuestas claras con un flujo visible.',
      subtitle:
        'Mientras Fastchat analiza tu solicitud y selecciona servicios, veras una animacion activa y etapas de progreso en tiempo real.',
      emptyKicker: 'Haz una pregunta',
      emptyTitle: 'Empieza con una consulta o usa una sugerencia para probar el nuevo flujo.',
      emptyText:
        'La interfaz ahora muestra actividad mientras el sistema prepara el contexto, consulta servicios y construye la respuesta.',
      ...
      connectingText: 'Estamos preparando la sesion para que el flujo sea visible desde el primer momento.',
    ...
    messageLabels: {
      ...
      processingTitle: 'Seleccionando servicios y organizando el flujo',
      processingText:
        'Fastchat muestra cada etapa mientras decide que herramientas usar y como construir la respuesta.',
    },
    workflow: {
